...
async def send_start(update, context, deep_code=None):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("🆕 Yangi Qismlar", callback_data="recent_eps")],
...
async def inline_menu_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif data == "recent_eps":
        await recent_episodes_panel(update, context)
...
def main():
    ...
    app.add_handler(CallbackQueryHandler(inline_menu_callback, pattern="^(anime_search|kabinet|shorts|reklama|recent_eps)$"))
    app.add_handler(CallbackQueryHandler(recent_episode_open_callback, pattern="^recep_"))
