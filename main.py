...
async def send_anime_info(bot, chat_id, code):
    ...
    if len(seasons) == 1:
        ...
        await _send_season_info(
            bot, chat_id, name, genre, desc, sid, poster_id, s_total,
            code=code, season_num=snum, show_season_label=False, poster_type=main_poster_type, ep_label=s_label,
...
async def _episode_send_kwargs(bot, chat_id, video_file_id, caption, season):
    ...
    if season and season[3] and season[5] == "photo":
        try:
            ...
            kwargs["thumbnail"] = InputFile(BytesIO(cover_bytes), filename="episode_cover.jpg")
