...
ADMIN_BUTTONS = {
    ...
    "🆕 Yangi Qismlar", "🛠 Qism Boshqarish", "💾 Backup Olish", "♻️ Backup Tiklash",
...
_MENU_BTN_FILTER = filters.Regex(
    ...
    r"|📢 Reklama|📺 Animelar Kanali|📤 Kanalga Yuborish|👥 Adminlar|🆕 Yangi Qismlar|🛠 Qism Boshqarish|💾 Backup Olish|♻️ Backup Tiklash|⏭ Shorts.*)$"
)
