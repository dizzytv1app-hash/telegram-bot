...
WEBAPP_URL = os.environ.get("WEBAPP_URL", "https://aninova-app.vercel.app/?admin=1")

# Saytning ochiq (admin bo'lmagan) manzili — "Sayt" bosilganda shu yerga
# havola beriladi.
SITE_URL = os.environ.get("SITE_URL", "https://aninova-app.vercel.app/")
