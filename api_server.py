...
def _row_to_summary(row: sqlite3.Row) -> dict:
    ...
    return {
        ...
        "posterUrl": f"/api/poster/{code}" if has_photo_poster else None,
        "bannerUrl": f"/api/poster/{code}" if has_photo_poster else None,
        "rating": row["rating"],
