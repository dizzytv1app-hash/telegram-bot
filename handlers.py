# -*- coding: utf-8 -*-
"""
handlers.py — Barcha Telegram handler funksiyalari: foydalanuvchi buyruqlari,
inline tugma callback'lari, admin panel funksiyalari (anime qo'shish/o'chirish/
tahrirlash, xabar yuborish, kanal boshqaruvi, backup/restore va h.k.), hamda
suhbat (conversation) uchun umumiy "escape" fallback funksiyalari.

main.py dan ajratib olindi — mantiq BIR QATOR HAM o'zgartirilmadi.

MUHIM: _check_menu_escape() funksiyasi asl config/logging bo'limidan shu yerga
ko'chirildi, chunki u shu fayldagi _interrupt_fallback() ga bog'liq edi —
bu aylanma import (circular import) muammosining oldini oladi.
"""
import os
import shutil
import asyncio
